...
-- Don't close the tree when you open a file
...
require'nvim-tree'.setup {
    ...
    hijack_netrw        = true,
    -- open the tree when running vim
    open_on_setup       = false,
    ...
    view = {
        ...
        width = 30,
        -- height of the window, can be either a number (columns) or a string
        -- in `%`, for top or bottom side placement
        height = 30,
